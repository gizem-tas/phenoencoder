...
tensorflow.keras.Sequential autoencoder modea, as well as a 
...
def create_model(inputs, shape="sqrt", hl=3, bn=3, activation=LeakyReLU(), **kwargs):
    ...
    ae.add(Dense(bn, activation=activation, name="bottleneck"))
